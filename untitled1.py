...
#        print(' Using ' + str(self.ThreadsNum) + ' threads for collecting news ... ')
    ...
    def coroutine_run(self,totalPages,Range,initPageID,**kwarg):
        ...
        gevent.joinall(jobs)
#k= WebCrawlFromthreatpost(IP= '10.108.217.52',PORT=27017,dbName="test",collectionName="zhou-malware",ThreadsNum=6).multi_threads_run(340,10,1,url_Part_1='https://threatpost.com/category/malware-2/page/') 
j= WebCrawlFromthreatpost(IP= '10.108.217.52',PORT=27017,dbName="test",collectionName="zhou-malware-thehackernews",ThreadsNum=6).ConnDB()
